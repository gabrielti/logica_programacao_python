...
#author: Wellington Costa, Gabriel Takiguchi, Pedro Melo, Murilo Trippia 
#data: 26/03/24
#version: 1.0
#objective: game
#-------------------------------------------------------------------------
...
if(tempo_exe > 30):
        ...
        if(resposta == sub and tempo_exe <= 5):
            ...
            ponto2 = ponto2 + (10 - int(tempo_exe-5)*0.2)
        
        else:
            ponto2 = ponto2 + 0
    
print("pontuacao:",ponto2,"\n")
